...
gameLogicRemote.detect_gold = function(playerId,basicChip,cb){
 ...
 * fa pai
 * */
gameLogicRemote.fapai = function(rid,channel,channelService,playerId,cb){
 ...
 */
gameLogicRemote.restartGame = function(rid,channel,channelService,game_winner,playerId){
    //重新开始
    var param = {
        route:'onEnd',
        winner:game_winner
                ...
                gameDao.getAllChip(rid,function(err,all_chip){
                    playerDao.setGold(playerId,all_chip,function(err,res){
                        ...
                        gameDao.resetData(rid,function(err){
                            setTimeout(function(){
                                gameLogicRemote.fapai(rid,channel,channelService,playerId,function(){
