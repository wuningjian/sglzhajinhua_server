...
handler.game_process = function(msg,session,next){
    ...
    if(process == 'ready'){
        ...
        gameLogicRemote.allin(rid,msg.location,channel);
        ...
        gameLogicRemote.bipai(rid,msg.location1,msg.location2,channel,function(winner){
            var param = {
                route:'onBipai',
            ...
            gameDao.nextCurPlayer(rid,function(err){
                ...
                gameDao.getIsGameNum(rid,function(err,isGameNumArr){
                    ...
                    if(sum<=1){
                        ...
                        //                if(res.player_num>=2&&res.is_gaming==0){
        ...
        this.app.rpc.game.gameRemote.kick(session,uid,this.app.get('serverId'),rid,function(){
